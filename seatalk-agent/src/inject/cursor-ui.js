...
(function () {
  ...
  injectCSS('cursor-panel-css', [
    ...
    // Sidebar button — aligned with native SeaTalk icons (32x32, 20px gap)
    '.cursor-sidebar-btn {',
    '  width:32px; height:32px; display:flex; align-items:center; justify-content:center;',
    '  border-radius:8px; cursor:pointer; background:transparent; border:none; padding:0;',
    ...
    '.cursor-sidebar-btn svg { width:19px; height:19px; }',
  ...
  // ── Remote Popover CSS ──
  injectCSS('cursor-remote-css', [
    '.cursor-remote-popover {',
    ...
    '  display:flex; flex-direction:column; max-height:calc(100vh - 16px); overflow-y:auto;',
    '  font-family:-apple-system,BlinkMacSystemFont,sans-serif;',
    '  opacity:0; transform:translateX(-6px); transition:opacity .15s, transform .15s;',
    '}',
    '.cursor-remote-popover.show { opacity:1; transform:translateX(0); }',
    '.alarm-group-cb {',
    ...
    '}',
    '.alarm-group-cb:hover { border-color:rgba(78,201,176,0.6); background:rgba(78,201,176,0.15); }',
    '.alarm-group-cb:checked {',
    '  background:#f59e0b; border-color:#f59e0b;',
    '}',
    '.alarm-group-cb:checked::after {',
    ...
    '  position:sticky; top:0; align-self:flex-end; margin-left:auto;',
    '  width:16px; height:12px; cursor:nesw-resize; flex-shrink:0; z-index:1;',
    '}',
    '.cursor-resize-handle::after {',
    '  content:""; position:absolute; right:2px; top:2px;',
    '  width:8px; height:8px; border-right:2px solid rgba(255,255,255,0.2);',
    '  border-top:2px solid rgba(255,255,255,0.2);',
    '}',
    '.cursor-resize-handle:hover::after {',
    ...
    '}',
    '.crp-row { margin-bottom:10px; }',
    '.crp-toggle {',
    '  display:inline-flex; align-items:center; gap:6px; padding:4px 10px;',
    '  border-radius:6px; background:rgba(255,255,255,0.04); border:1px solid rgba(255,255,255,0.08);',
    '  font-size:11px; color:rgba(255,255,255,0.5); cursor:pointer; transition:all .15s;',
    '  user-select:none;',
    '}',
    '.crp-toggle:hover { border-color:rgba(77,150,255,0.4); color:rgba(255,255,255,0.7); }',
    '.crp-toggle .gt-track {',
    '  width:24px; height:13px; border-radius:7px; background:#3d3d55;',
    ...
    '}',
    '.crp-toggle.on .gt-track { background:#4ec9b0; }',
    '.crp-toggle.on .gt-knob { left:13px; background:#fff; }',
    '.crp-toggle.on { border-color:rgba(78,201,176,0.4); color:#4ec9b0; }',
    '.crp-status {',
    '  font-size:11px; color:rgba(255,255,255,0.4); display:flex; align-items:center; gap:5px;',
    '}',
    '.crp-dot {',
    ...
    '}',
    '.crp-logs {',
    '  margin-top:10px; flex:1; min-height:0; max-height:280px; overflow-y:auto; font-size:10px;',
    '  font-family:"SF Mono",Monaco,Menlo,monospace; line-height:1.6;',
    '  border-top:1px solid rgba(255,255,255,0.06); padding-top:8px;',
    '  scrollbar-width:thin; scrollbar-color:rgba(255,255,255,0.1) transparent;',
    '}',
    '.crp-logs::-webkit-scrollbar { width:3px; }',
    '.crp-logs::-webkit-scrollbar-thumb { background:rgba(255,255,255,0.12); border-radius:2px; }',
    '.crp-log-empty {',
    '  color:rgba(255,255,255,0.2); font-style:italic; text-align:center;',
    '  padding:8px 0; font-family:inherit;',
    '}',
    '.crp-log-line {',
    '  color:rgba(255,255,255,0.5); padding:1px 0; white-space:pre-wrap; word-break:break-all;',
    '}',
    '.crp-log-line.warn { color:#e2b340; }',
    '.crp-log-line.error { color:#f14c4c; }',
    '.crp-log-time {',
    '  color:rgba(255,255,255,0.2); margin-right:6px; font-size:9px;',
    '}',
  ].join('\n'));
